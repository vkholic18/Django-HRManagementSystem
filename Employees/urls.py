...
from .views import employee_list,employee_detail,employee_delete,home,employee_edit,employee_add,team_list,team_detail,team_edit,employee_note,login_view,signup_view,logout_view,organization,team_add
